...
const Login = () => {
  ...
  return (
    <div className="w-11/12 mx-auto mt-5 mb-5">
      <Navbar />
      <div className="w-full max-w-md mx-auto p-8 space-y-3 rounded-xl bg-gray-100 text-gray-800 shadow-xl mt-16 mb-16">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-1 text-sm">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-md border-gray-300 bg-gray-50text-gray-800 focus:border-violet-600"
            />
